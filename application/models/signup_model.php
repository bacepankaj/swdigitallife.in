		...
		*/
		...
		function submit(){
            ...
            if(is_object($user)){
                ...
                // show error message
                MsgBox::view()->show(Lang::error('003', array('mobile'=>$mobile, 'name'=>$name))->msg, Lang::error('003')->title, null, true, 1, 'success.svg', APP_PATH.'/signup/verify?verificationCode='.$this->functions->encrypt_decrypt('encrypt', json_encode(array('mobile'=>$mobile, 'name'=>$name))), APP_PATH.'/signup');	
            }
		}
